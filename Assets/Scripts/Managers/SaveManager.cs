...
namespace Managers
{
  public static class SaveManager
  {
    ...
    public static void SaveGame(Player player, string sceneRef, int day)
    {
      ...
      FileStream stream = new FileStream(infoPath, FileMode.Create);

      // Get the data and seralise it
      Data data = new Data(player, sceneRef, day);
    ...
    public static Data LoadGame()
    {
      ...
      {
        BinaryFormatter formatter = new BinaryFormatter();
        FileStream stream = new FileStream(infoPath, FileMode.Open);
    ...
    public static string GetInfoPath() { return infoPath; }
    ...
    public static bool FileExists(int saveFileIndex) { return File.Exists(SaveFilePath(saveFileIndex)); }
