...
namespace Enemies
{
    public class Wolf : Enemy
    {
        ...
        private new void Awake()
        {
            ...
            // stalking
            var howl = new Ability("Howl", 0, 30, 0, 0.3f, Howl);
        ...
        protected void Stalk()
        {
            ...
            var currentStalk = GetStatus<Stalk>();
