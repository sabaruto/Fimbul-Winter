...
namespace Misc
{
  ...
  public class Movement : MonoBehaviour
  {
    ...
    // Sets the grid
    public void SetGrid(MyGrid grid) { this.grid = grid; }
    ...
    private void Move()
    {
      ...
      for (var nodeIndex = currentNodeIndex; nodeIndex < currentNodes.Length;
        nodeIndex++)
    ...
    public float GetSpeed() { return speed; } //GetSpeed
    ...
    public Vector2 GetDir() { return dirPosition; }

    public void UpdateDir(Vector2 dirPosition) { this.dirPosition = dirPosition; }
