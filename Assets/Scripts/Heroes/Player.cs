...
namespace Heroes
{
  public class Player : Character, IInformation
  {
    ...
    // The piercing arrow
    [FormerlySerializedAs("piercingArrow")] [SerializeField] private GameObject piercingArrowObject;
    ...
    public new void Awake()
    {
      ...
      // Abilities
      Ability volley = new Ability("Volley", 1, 5, 20, 0.5f, StartVolley, 0.25f);
      Ability piercingArrow = new Ability("Piercing Arrow", 5, 1, 5, 10f / 24f,
        PiercingArrow, 0.125f);
      Ability poison = new Ability("Poison", 0, 5f, 10, 0, Poison);
      Ability dash = new Ability("Dash", 0, 2, 0, 0, Dash);
    ...
    public void LateUpdate() { ShowGui(); }
    ...
    private void Movement()
    {
      ...
      if (currentHelper != null)
      {
        ...
        Vector2 standPosition = currentHelper.GetStandPosition();
    ...
    public void SetSkillStatus(Dictionary<string, SkillState> statuses) { skillStatus = statuses; }

    public Dictionary<string, SkillState> GetSkillStatus() { return skillStatus; }
    ...
    private void PiercingArrow()
    {
      ...
      GameObject arrow = Instantiate(piercingArrowObject, transform.position,
        Quaternion.identity);

      // Getting the projectile component
      Projectile arrowProj = arrow.GetComponent<Projectile>();
    ...
    public void IncreaseSkillPoints(int value) { skillPoints += value; }
