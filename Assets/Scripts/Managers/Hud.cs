...
namespace Managers
{
  ...
  public class Hud : MonoBehaviour
  {
    ...
    private void DrawStatuses()
    {
      ...
      for (var statusIndex = 0; statusIndex < playerStatuses.Length;
        statusIndex++)
      {
        ...
        if (statusUi.Count == statusIndex)
        {
          ...
          GameObject statusGameObject = new GameObject("icon #" + statusIndex);
          ...
          RectTransform orientation = statusGameObject.GetComponent<RectTransform>();
        ...
        Image statusIcon = statusUi[statusIndex].GetComponent<Image>();
        statusIcon.color = playerStatuses[statusIndex].GetColor();


        StatusInfo statusInfo = statusUi[statusIndex].GetComponent<StatusInfo>();
      ...
      for (var emptyIconIndex = playerStatuses.Length;
        emptyIconIndex < statusUi.Count; emptyIconIndex++)
      {
    ...
    private void AddCooldownAbilites(Ability ability) { coolDownAbilities.Add(ability); }
  }
}