namespace Base_Classes
{
  public class Ability
  {
    ...
    // The boolean to checkif the ability is finishing
    ...
    public void SetCoolDown() { coolDown = maxCoolDown; } //setCoolDown
    ...
    public void DecreaseCoolDown(float deltaTime)
    {
      ...
      // clause when the timer htis zero
      if (isFinishing)
      {
