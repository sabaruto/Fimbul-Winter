...
namespace Enemies
{
    public class Troll : Enemy
    {
        ...
        private new void Awake()
        {
            ...
            //(add root)
            var smash = new Ability("Smash", 20, 5, 0, 1f, Smash, 0.583f);

            //Rattle, troll hits the ground, causing it to shake and slowing the player if he is
            //in the area of damage
            var rattle = new Ability("Rattle", 0, 5, 0, 0.3f, StartRattle);

            //This ability hurls a boulder at the player
            var rockThrow = new Ability("Rock Throw", 2, 5, 0, 0.667f, RockThrow, 2f);
        ...
        private void RockThrow()
        {
            ...
            var rock = Instantiate(rockProjectile, transform.position,
                Quaternion.identity);
